...
var hit_sound = preload("res://sounds/Futuristic SMG Single Shot.wav")
var dink_sound = preload("res://sounds/hitHead.wav")

var unaim_pos = Vector3(0.319, -0.292, -0.753)
var aim_pos = Vector3(0, 0.5, -0.5)
...
func _ready():
	Input.set_mouse_mode(Input.MOUSE_MODE_CAPTURED)
	blaster = $Head/Camera3D/P90
	muzzle = $Head/Camera3D/P90/CSGCylinder3D
